...
const SIM_STATES: { id: SimState; label: string; icon: string; desc: string }[] = [
  ...
  { id: "connected",     label: "Wallet Connected",      icon: "✅", desc: "Wallet connected on BNB Smart Chain (Chain 56)" },
    ...
    <div className="rounded-xl border border-white/10 overflow-hidden">
      {state === "wrong_network" && (
        <div className="bg-yellow-500/10 border-b border-yellow-500/20 px-4 py-2 text-center text-xs text-yellow-300">
          ⚠️ Your wallet is on the wrong network. Switch to <strong>Polygon (Chain ID 137)</strong> to use this app.
        </div>
      )}
