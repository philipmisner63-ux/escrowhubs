...
export const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "Yes. Any WalletConnect-compatible mobile wallet works. Trust Wallet and MetaMask Mobile have been tested on BNB Chain.",
  },
];
...
export const ONBOARDING_STEPS = [
  ...
  },
  {
    ...
    description: `Make sure your wallet is on BNB Smart Chain (Chain ID ${DEFAULT_CHAIN_ID}). The app will prompt you to switch automatically.`,
    icon: "🌐",
