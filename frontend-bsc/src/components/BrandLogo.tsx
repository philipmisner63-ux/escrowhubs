...
/**
 * BrandLogo — EscrowHubs logo with optional glow animation and tagline.
 * animated=true  → hero version with pulsing halo + gradient tagline
 * animated=false → static version for nav/footer
 */
export default function BrandLogo({
  ...
  const taglineBarStyle: React.CSSProperties = {
  ...
  return (
    <div className="flex flex-col items-center justify-center select-none">
      ...
      {showTagline && animated && (
        <div className="mt-4 px-6 py-2 rounded-full" style={taglineBarStyle}>
          <span style={taglineTextStyle}>
