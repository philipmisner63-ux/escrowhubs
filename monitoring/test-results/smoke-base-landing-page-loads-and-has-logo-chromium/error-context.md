...
- Name: smoke.spec.ts >> base >> landing page loads and has logo
...
Locator: locator('[data-testid="brand-logo"]')
Expected: visible
Error: strict mode violation: locator('[data-testid="brand-logo"]') resolved to 2 elements:
    1) <svg viewBox="0 0 100 100" aria-label="EscrowHubs" data-testid="brand-logo" xmlns="http://www.w3.org/2000/svg">…</svg> aka getByRole('link', { name: 'EscrowHubs EscrowHubs' })
    2) <svg viewBox="0 0 100 100" aria-label="EscrowHubs" data-testid="brand-logo" xmlns="http://www.w3.org/2000/svg">…</svg> aka getByRole('contentinfo').getByTestId('brand-logo')

Call log:
  - Expect "toBeVisible" with timeout 10000ms
  - waiting for locator('[data-testid="brand-logo"]')
        ...
        - main:
          - generic:
            ...
            - generic:
              ...
              - generic: "Multi-chain: Base, Polygon, BNB Chain"
          - generic:
            - generic:
              - generic:
          ...
          - generic:
            ...
            - generic:
              - generic:
                ...
                - paragraph: 0.5% protocol fee on all escrows · +0.001 ETH flat fee when AI Arbiter is selected
              - link "Create Escrow →":
                - /url: /en/create
          - generic:
            - generic:
            ...
            - generic:
              ...
              - generic:
                ...
                - list:
                  ...
                  - listitem:
                    - link "Discord":
                      - /url: https://discord.gg/BsBudsMhgt
                      - text: Discord
                      - img
          - generic:
            - generic:
