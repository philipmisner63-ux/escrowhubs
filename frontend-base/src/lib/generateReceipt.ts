...
export async function generateReceipt(data: ReceiptData): Promise<void> {
  ...
  doc.text("Trustless escrow powered by Base", margin, 20);
  ...
  doc.text(
    "This transaction is permanently and immutably recorded on the Base blockchain. It cannot be altered or deleted.",
  ...
  doc.setFontSize(7.5);
  doc.setTextColor("#64748b");
  doc.text("This receipt was generated by EscrowHubs — base.escrowhubs.io", W / 2, 280, { align: "center" });
