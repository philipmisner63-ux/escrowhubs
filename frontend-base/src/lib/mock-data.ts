...
export const mockEscrows: Escrow[] = [
  {
    ...
    milestones: [
      { id: 0, description: "Kickoff & Scope", amount: "0.5 BDAG", status: "released" },
      { id: 1, description: "Initial Report", amount: "1.0 BDAG", status: "pending" },
      { id: 2, description: "Final Delivery", amount: "1.0 BDAG", status: "pending" },
    ],
  },
  {
    id: "0x5e6f7a8b",
  ...
  },
  {
    ...
    milestones: [
      { id: 0, description: "Auth System", amount: "1.0 BDAG", status: "released" },
      { id: 1, description: "Core APIs", amount: "2.0 BDAG", status: "disputed" },
      { id: 2, description: "Testing & Docs", amount: "1.0 BDAG", status: "pending" },
    ],
  },
];
