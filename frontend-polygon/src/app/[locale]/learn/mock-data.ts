...
export const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "Yes. Any WalletConnect-compatible mobile wallet works. Trust Wallet and MetaMask Mobile have been tested on Polygon.",
  },
];
...
export const ONBOARDING_STEPS = [
  ...
  },
  {
    ...
    description: `Make sure your wallet is on Polygon (Chain ID ${DEFAULT_CHAIN_ID}). The app will prompt you to switch automatically.`,
    icon: "🌐",
