        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          <div className="space-y-4">
            ...
            <p className="text-sm text-slate-400 leading-relaxed max-w-xs">
              Safe payments for African freelancers and clients. Get paid with confidence.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2.5">
              ...
              <li><Link href="/create" className="text-sm text-slate-500 hover:text-cyan-400 transition-colors">Request Payment</Link></li>
              <li><Link href="/dashboard" className="text-sm text-slate-500 hover:text-cyan-400 transition-colors">My Payments</Link></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2.5">
              <li>
                <a href="https://x.com/" target="_blank" rel="noopener noreferrer" className="text-sm text-slate-500 hover:text-cyan-400 transition-colors inline-flex items-center gap-1.5">
                  Twitter
              ...
              <li>
                <a href="https://t.me/" target="_blank" rel="noopener noreferrer" className="text-sm text-slate-500 hover:text-cyan-400 transition-colors inline-flex items-center gap-1.5">
                  Telegram
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="opacity-40">
                    <path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" />
                    <polyline points="15 3 21 3 21 9" />
      ...
      <div className="border-t border-white/5">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-4 flex flex-col sm:flex-row items-center justify-between gap-3">
          <div className="flex items-center gap-2 text-xs text-slate-600">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-cyan-400/40">
              <path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71" />
              <path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71" />
            </svg>
            Secure payments powered by EscrowHubs
          </div>
